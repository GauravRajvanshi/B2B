...
import com.mitre.fulfilmentprocess.test.actions.TestActionTemp;
...
public class PaymentIntegrationTest extends ServicelayerTest
{
	...
	public static void prepare() throws Exception //NOPMD
	{
		...
		xmlReader.loadBeanDefinitions(new ClassPathResource(
				"/mitrefulfilmentprocess/test/mitrefulfilmentprocess-spring-test.xml"));
		xmlReader.loadBeanDefinitions(new ClassPathResource(
				"/mitrefulfilmentprocess/test/mitrefulfilmentprocess-spring-test-fraudcheck.xml"));
		xmlReader
				.loadBeanDefinitions(new ClassPathResource("/mitrefulfilmentprocess/test/process/order-process-spring.xml"));
	...
	public void setUpProductCatalogue()
	{
		try
		{
			...
			importCsv("/mitrefulfilmentprocess/test/testBasics.csv", "windows-1252");
			importCsv("/mitrefulfilmentprocess/test/testCatalog.csv", "windows-1252");
