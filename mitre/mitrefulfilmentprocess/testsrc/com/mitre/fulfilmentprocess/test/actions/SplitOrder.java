 ...
 *
 */
package com.mitre.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(MitreFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(MitreFulfilmentProcessConstants.PARENT_PROCESS);
