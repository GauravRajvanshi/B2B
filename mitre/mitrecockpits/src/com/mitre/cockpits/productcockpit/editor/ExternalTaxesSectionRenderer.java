 ...
 *
 */
package com.mitre.cockpits.productcockpit.editor;
			...
			if (section instanceof CustomEditorSection)
			{
				...
				if (customSection.getSectionConfiguration() instanceof ExternalTaxesSectionConfiguration)
				{
					...
					if (secConfig != null)
					{
						...
						final Label rowLabel = new Label(Labels.getLabel("mitrecockpits.product.externalTaxes"));
						rowLabel.setTooltiptext(Labels.getLabel("mitrecockpits.product.externalTaxes"));
