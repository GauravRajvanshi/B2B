 ...
 *
 */
package com.mitre.cockpits.setup;
...
import com.mitre.cockpits.constants.MitreCockpitsConstants;
 ...
 */
@SystemSetup(extension = MitreCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(MitreCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(MitreCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						MitreCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/mitrecockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
