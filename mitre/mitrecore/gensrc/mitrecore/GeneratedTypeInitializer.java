...
public class GeneratedTypeInitializer extends AbstractTypeInitializer
{
	...
	protected final void performCreateTypes( final ManagerEJB manager, Map params ) throws JaloBusinessException
	{
		...
		createItemType(
			...
			"CronJob",
			com.mitre.core.jalo.MultipleCatalogsSyncCronJob.class,
			null,
			false,
			null,
			false
		...
		createItemType(
			...
			"VariantProduct",
			com.mitre.core.jalo.PowertoolsSizeVariantProduct.class,
			null,
			false,
			null,
			false
		...
		createItemType(
			...
			"GenericItem",
			com.mitre.core.jalo.btg.OrganizationOrderStatistics.class,
			"de.hybris.platform.persistence.mitrecore_OrganizationOrderStatistics",
			false,
			null,
			false
		);
		...
		createItemType(
			...
			"CronJob",
			com.mitre.core.jalo.btg.OrganizationOrdersReportingCronJob.class,
			null,
			false,
			null,
			false
		...
		createItemType(
			...
			com.mitre.core.jalo.btg.BTGOrganizationTotalSpentInCurrencyLastYearOperand.class,
			null,
			false,
			null,
			false
		...
		createItemType(
			...
			"BTGOrganizationTotalSpentInCurrencyLastYearOperand",
			com.mitre.core.jalo.btg.BTGOrganizationTotalSpentInCurrencyRelativeDatesOperand.class,
			null,
			false,
			null,
			false
