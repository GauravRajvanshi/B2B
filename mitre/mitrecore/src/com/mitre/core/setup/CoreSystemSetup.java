 ...
 */
@SystemSetup(extension = MitreCoreConstants.EXTENSIONNAME)
public class CoreSystemSetup extends AbstractSystemSetup
{
	...
	{
		importImpexFile(context, "/mitrecore/import/essential-data.impex");
		importImpexFile(context, "/mitrecore/import/countries.impex");
		importImpexFile(context, "/mitrecore/import/delivery-modes.impex");

		importImpexFile(context, "/mitrecore/import/themes.impex");
	}
	...
	public void createProjectData(final SystemSetupContext context)
	{
		...
		{
			importImpexFile(context, "/mitrecore/import/cockpits/cmscockpit/cmscockpit-users.impex");
			importImpexFile(context, "/mitrecore/import/cockpits/cmscockpit/cmscockpit-access-rights.impex");
		}

		if (importAccessRights && extensionNames.contains("btgcockpit"))
		{
			importImpexFile(context, "/mitrecore/import/cockpits/cmscockpit/btgcockpit-users.impex");
			importImpexFile(context, "/mitrecore/import/cockpits/cmscockpit/btgcockpit-access-rights.impex");
		}

		if (importAccessRights && extensionNames.contains("productcockpit"))
		{
			importImpexFile(context, "/mitrecore/import/cockpits/productcockpit/productcockpit-users.impex");
			importImpexFile(context, "/mitrecore/import/cockpits/productcockpit/productcockpit-access-rights.impex");
			importImpexFile(context, "/mitrecore/import/cockpits/productcockpit/productcockpit-constraints.impex");
		}

		if (importAccessRights && extensionNames.contains("cscockpit"))
		{
			importImpexFile(context, "/mitrecore/import/cockpits/cscockpit/cscockpit-users.impex");
			importImpexFile(context, "/mitrecore/import/cockpits/cscockpit/cscockpit-access-rights.impex");
		}

		if (extensionNames.contains("mcc"))
		{
			importImpexFile(context, "/mitrecore/import/mcc-sites-links.impex");
		}
	...
	public PerformResult executeCatalogSyncJob(final SystemSetupContext context, final String catalogName)
	{
		...
		importImpexFile(context, "/mitrecore/import/catalogs-sync.impex", true);
	...
	protected void importProductCatalog(final SystemSetupContext context, final String catalogName)
	{
		...
		importImpexFile(context, "/mitrecore/import/productCatalogs/" + catalogName + "ProductCatalog/catalog.impex",
				true);
	...
	protected void createAndActivateSolrIndex(final SystemSetupContext context, final String storeName)
	{
		...
		importImpexFile(context, "/mitrecore/import/stores/" + storeName + "/solr.impex");

		createSolrIndexerCronJobs(storeName + "Index");

		importImpexFile(context, "/mitrecore/import/stores/" + storeName + "/solrtrigger.impex");
	...
	protected void importContentCatalog(final SystemSetupContext context, final String catalogName)
	{
		...
		importImpexFile(context, "/mitrecore/import/contentCatalogs/" + catalogName + "ContentCatalog/catalog.impex",
				true);
		importImpexFile(context, "/mitrecore/import/contentCatalogs/" + catalogName + "ContentCatalog/cms-content.impex",
				false);
		importImpexFile(context, "/mitrecore/import/contentCatalogs/" + catalogName
	...
	protected void importStore(final SystemSetupContext context, final String storeName)
	{
		...
		importImpexFile(context, "/mitrecore/import/stores/" + storeName + "/store.impex");
		importImpexFile(context, "/mitrecore/import/stores/" + storeName + "/site.impex");
